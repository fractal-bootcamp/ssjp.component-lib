    ...
    <AnimatePresence>
      {shouldRender && (
        <motion.div 
          ...
          <div className="relative font-roboto text-center font-semibold bg-bark-light text-sky p-2 min-w-[150px] w-fit max-w-[300px] rounded-md shadow-lg">
            <div className="
            ...
            <div className={`absolute w-2 h-2 bg-bark-light transform rotate-45 ${getCaratPositionClasses(position)}`}></div>
          </div>
        </motion.div>
      )}
      </AnimatePresence>
